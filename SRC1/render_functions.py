...
# ** docs:
# *** auto():
 # if you’re working on Python 3.6, you can make this a lot easier with the auto() function.
    # STAIRS = auto()
    # CORPSE = auto()
    # ITEM   = auto()
    # ACTOR  = auto()
...
# ** Interfase : 
    ...
    libtcod.console_print_ex(panel, 1, 3,
                             libtcod.BKGND_NONE, libtcod.LEFT,
                             'Dungeon level: {0}'.format(
                                 game_map.dungeon_level))
    libtcod.console_set_default_foreground(panel, libtcod.light_gray)
    libtcod.console_print_ex(panel, 1, 0,
                             libtcod.BKGND_NONE, libtcod.LEFT,
